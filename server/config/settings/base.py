...
LOCAL_APPS = [
    ...
    'server.core.apps.CoreAppConfig',
...
ADMINS = [
    ("""Artem.Bernatskyi, Konstantin Pristavskiy, Roman Malyarchuk""", 'artem.bernatskyy@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['server.taskapp.celery.CeleryAppConfig']
if USE_TZ:
